...
export const SCREEN_EVENT_BY_NAME = {
  ...
  ProviderDashboard: ANALYTICS_EVENTS.SCREEN_VIEW_PROVIDER_DASHBOARD,
  ProviderAgenda: ANALYTICS_EVENTS.SCREEN_VIEW_PROVIDER_AGENDA,
  ProviderOperations: ANALYTICS_EVENTS.SCREEN_VIEW_PROVIDER_OPERATIONS,
  ProviderProfile: ANALYTICS_EVENTS.SCREEN_VIEW_PROVIDER_PROFILE,
} as const;
